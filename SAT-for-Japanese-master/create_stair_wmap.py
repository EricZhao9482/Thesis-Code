...
def main(args):
    if args.en:
        ...
        with open("STAIR-captions/stair_captions_v1.2_train_tokenized.json", 'r', encoding="utf-8") as f:
            train = json.load(f)

        with open("STAIR-captions/stair_captions_v1.2_val_tokenized.json", 'r', encoding="utf-8") as f:
            val = json.load(f)
